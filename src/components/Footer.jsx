...
const Footer = () => {
    ...
    const logoSrc = mounted && theme === "dark" 
        ? "/doctor-appoint-logo-dark.png" 
        : "/doctor-appoint-light-logo.png";
            ...
            <div className="container mx-auto grid gap-8 px-4 py-12 md:grid-cols-3">
                ...
                <div>
                    <div className="flex items-center gap-2">
                        <div className="grid h-10 w-10 place-items-center rounded-xl bg-brand text-brand-foreground overflow-hidden">
                            {mounted ? (
                                <Image 
                                    alt="DocAppoint Logo"
                                    src={logoSrc}
                                ...
                                <div className="h-8.5 w-8.5 bg-muted/20 rounded-full animate-pulse" />
                            )}
                        </div>
                ...
                {/* Socials & Copyright */}
                <div>
                    <h4 className="mb-3 text-sm font-semibold text-foreground">Follow us</h4>
                    <div className="flex items-center gap-3">
                        <a
                            aria-label="Facebook"
                            href="#"
                            className="grid h-9 w-9 place-items-center rounded-full bg-background border border-border hover:bg-accent text-muted-foreground hover:text-foreground transition-colors"
                        >
